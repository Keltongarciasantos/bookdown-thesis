...
```
Os fenómenos aleatórios que se desenrolam no tempo são objeto de estudo de *processos estocásticos*. Os processos estocásticos são os modelos matemáticos que descrevem os fenómenos aleatórios que evoluem ao longo do tempo.
